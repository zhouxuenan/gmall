...
public class ItemService {
    ...
    public ItemVo loadData(Long skuId) {
        ...
        //10.根据spuId查询spu下的所有sku和销售属性组合的映射关系
        ...
        //12.根据cid spuId skuId查询组及组下的规格参数及值
        CompletableFuture<Void> groupCompletableFuture = skuCompletableFuture.thenAcceptAsync(skuEntity -> {
            ResponseVo<List<ItemGroupVo>> groupResponseVo = this.pmsClient.queryGroupWithAttrValuesByCidAndSpuIdAndSkuId(skuEntity.getCatagoryId(), skuEntity.getSpuId(), skuId);
...
//                e.printStackTrace();
//            }
//            System.out.println("这个任务是thenRunAsync任务");
//        });
